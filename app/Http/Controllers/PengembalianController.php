...
class PengembalianController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.pengembalian', compact('anggota','petugas','buku','pengembalian'));
    }
    ...
    public function tambah(){
        ...
        return view('admin.pengembalian_tambah',compact('anggota','buku','petugas'));
    ...
    public function edit($id){
        ...
        $buku = DB::table('buku')->pluck("JUDUL_BUKU","ID_BUKU");
        $petugas = DB::table('petugas')->pluck("NAMA_PETUGAS","ID_PETUGAS");
        return view('admin.edit_pengembalian',compact('anggota','buku','petugas','pengembalian'));
    }
    ...
    public function cari(Request $request)
	{
        ...
        ->where('pengembalian.ID_PENGEMBALIAN','like',"%".$cari."%")
        ->orWhere('pengembalian.TANGGAL_PENGEMBALIAN','like',"%".$cari."%")
        ->orWhere('buku.JUDUL_BUKU','like',"%".$cari."%")
		->orWhere('anggota.NAMA_ANGGOTA','like',"%".$cari."%")
		->orWhere('petugas.NAMA_PETUGAS','like',"%".$cari."%") 
        ->paginate();
    		// mengirim data pegawai ke view index
		return view('admin.pengembalian',['pengembalian' => $pengembalian]);
    ...
    public function tongSampah(){
    	...
    	return view('admin.pengembalian_tongSampah', ['pengembalian' => $pengembalian]);
    }
