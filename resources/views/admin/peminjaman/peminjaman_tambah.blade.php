...
<!-- Content -->
	...
	<form action="{{url('/peminjaman/peminjaman/simpan')}}" method="post">
		...
		<div class="form-group">
			...
			<input class="form-control" type="date" name="TANGGAL_PINJAM" id="TANGGAL_PINJAM" placeholder="">
		</div>
		<div class="form-group">
			<label for="stok">Tanggal Kembali</label>
			<input class="form-control" type="date" name="TANGGAL_KEMBALI" id="TANGGAL_KEMBALI" placeholder="">
		</div>
