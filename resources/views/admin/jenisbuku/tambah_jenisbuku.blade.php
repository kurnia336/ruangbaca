...
<!-- Content -->
	...
	<form action="{{url('/jenisbuku_simpan')}}" method="post">
		...
		<div class="form-group">
			...
			<input class="form-control" type="hidden" name="ID_JENISBUKU" id="ID_JENISBUKU" placeholder="Masukkan ID Jenis Buku" required="true" autocomplete="off" required>
		</div>
		<div class="form-group">
			<label for="nama_rak">Jenis Buku</label>
			<input class="form-control" type="text" name="NAMA_JENISBUKU" id="NAMA_JENISBUKU" placeholder="Masukkan Nama Rak" autocomplete="off" required>
		</div>
