...
Route::group(['middleware' => ['auth', 'CheckRole:Admin']],function(){
   ...
   // Route::get('/buku/nonaktif_buku/{id_buku}','BukuController@nonaktif_buku');
   // Route::get('/buku/aktifkan_buku/{id_buku}','BukuController@aktifkan_buku');
   // Route::get('/buku/buku_tongSampah','BukuController@buku_tongSampah');
   ...
   Route::get('/petugas/nonaktif_petugas/{id_petugas}','PetugasController@nonaktif_petugas');
   Route::get('/petugas/aktifkan_petugas/{id_petugas}','PetugasController@aktifkan_petugas');
   Route::get('/petugas/petugas_tongSampah','PetugasController@petugas_tongSampah');
   ...
   // Route::get('/anggota/nonaktif_anggota/{id_anggota}','AnggotaController@nonaktif_anggota');
   // Route::get('/anggota/aktifkan_anggota/{id_anggota}','AnggotaController@aktifkan_anggota');
   // Route::get('/anggota/anggota_tongSampah','AnggotaController@anggota_tongSampah');
   ...
   // Route::get('/rak/nonaktif_rak/{id_rak}','RakController@nonaktif_rak');
   // Route::get('/rak/aktifkan_rak/{id_rak}','RakController@aktifkan_rak');
   // Route::get('/rak/rak_tongSampah','RakController@rak_tongSampah');
   ...
   // Route::get('/jenisbuku_edit/{id_jenisbuku}', 'JenisbukuController@edit')->name('jenisbuku_edit');
   // Route::post('/jenisbuku_update', 'JenisbukuController@update')->name('jenisbuku_update');
   // Route::get('/jenisbuku_hapus/{id_jenisbuku}', 'JenisbukuController@hapus')->name('jenisbuku_hapus');
   // Route::get('/jenisbuku_cari','JenisbukuController@cari');//nambah route cari
   // Route::get('/jenisbuku/nonaktif_jenisbuku/{id_penerbit}','JenisbukuController@nonaktif_jenisbuku');
   // Route::get('/jenisbuku/aktifkan_jenisbuku/{id_penerbit}','JenisbukuController@aktifkan_jenisbuku');
   // Route::get('/jenisbuku/jenisbuku_tongSampah','JenisbukuController@jenisbuku_tongSampah');
   ...
   // Route::get('/penerbit/nonaktif_penerbit/{id_penerbit}','PenerbitController@nonaktif_penerbit');
   // Route::get('/penerbit/aktifkan_penerbit/{id_penerbit}','PenerbitController@aktifkan_penerbit');
   // Route::get('/penerbit/penerbit_tongSampah','PenerbitController@penerbit_tongSampah');
   ...
   // Route::get('/cari_petugas', 'PeminjamanController@loadData_petugas');
...
Route::group(['middleware' => ['auth', 'CheckRole:Admin,Petugas,Anggota']],function(){
...
Route::group(['middleware' => ['auth', 'CheckRole:Anggota']],function(){
   Route::get('/peminjaman/historyPeminjaman','HistoryPeminjamanController@index');
});
// Route::get('/about', function () {
//    return view('admin/about');
// });
